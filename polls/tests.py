...
def create_question(question_text, days):
	"""
	creates a question with the given 'question text' and published the given
	number of 'days' offset to now (negative for questions published in the 
	past, positive for future published questions))
	"""
...
class QuestionViewTests(TestCase):
	def test_index_view_no_qs(self):
		"""
	...
	def test_index_view_past_q(self):
		"""
	...
	def test_index_view_future_q(self):
		"""
